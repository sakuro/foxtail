...
This document describes the release process for the Foxtail gem, which is fully automated through GitHub Actions workflows.
...
- Update `lib/foxtail/version.rb` with the new version
- Update `CHANGELOG.md`:
