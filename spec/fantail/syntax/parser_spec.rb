...
RSpec.describe Fantail::Syntax::Parser do
  ...
  describe "simple parsing" do
    it "parses empty resources" do
      result = parser.parse("")
      expect(result).to be_a(Fantail::Syntax::Parser::AST::Resource)
    ...
    it "parses simple messages" do
      ...
      expect(message).to be_a(Fantail::Syntax::Parser::AST::Message)
      expect(message.id.name).to eq("hello")
      expect(message.value).to be_a(Fantail::Syntax::Parser::AST::Pattern)
      expect(message.value.elements.length).to eq(1)
      expect(message.value.elements.first).to be_a(Fantail::Syntax::Parser::AST::TextElement)
    ...
    it "parses terms" do
      ...
      expect(term).to be_a(Fantail::Syntax::Parser::AST::Term)
    ...
    it "parses comments" do
      ...
      expect(comment).to be_a(Fantail::Syntax::Parser::AST::Comment)
  ...
  describe "error handling" do
    it "creates junk for invalid entries" do
      ...
      expect(junk).to be_a(Fantail::Syntax::Parser::AST::Junk)
