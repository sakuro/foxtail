...
RSpec.describe Fantail::Bundle::Parser do
  let(:parser) { Fantail::Bundle::Parser.new }
  ...
  describe "#parse" do
    ...
    describe "placeables" do
      it "parses message with variable reference" do
        ...
        expect(message.value[1]).to be_a(Fantail::Bundle::Parser::AST::VariableReference)
      ...
      it "parses message with message reference" do
        ...
        message = result.first
        expect(message.value).to be_a(Array)
        expect(message.value[1]).to be_a(Fantail::Bundle::Parser::AST::MessageReference)
      ...
      it "parses message with term reference" do
        ...
        message = result.first
        expect(message.value).to be_a(Array)
        expect(message.value[1]).to be_a(Fantail::Bundle::Parser::AST::TermReference)
      ...
      it "parses message with function call" do
        ...
        message = result.first
        expect(message.value).to be_a(Array)
        expect(message.value[0]).to be_a(Fantail::Bundle::Parser::AST::FunctionReference)
    ...
    describe "select expressions" do
      it "parses select expression with string variants" do
        ...
        expect(select).to be_a(Fantail::Bundle::Parser::AST::SelectExpression)
      ...
      it "parses select expression with number variants" do
        ...
        message = result.first
        select = message.value[0]
        expect(select.variants[0].key).to be_a(Fantail::Bundle::Parser::AST::NumberLiteral)
    ...
    describe "literals" do
      it "parses number literals" do
        ...
        message = result.first
        expect(message.value[0]).to be_a(Fantail::Bundle::Parser::AST::NumberLiteral)
      ...
      it "parses string literals" do
        ...
        message = result.first
        expect(message.value[0]).to be_a(Fantail::Bundle::Parser::AST::StringLiteral)
    ...
    describe "named arguments" do
      it "parses function with named arguments" do
        ...
        expect(func).to be_a(Fantail::Bundle::Parser::AST::FunctionReference)
        expect(func.args.length).to eq(2)
        expect(func.args[1]).to be_a(Fantail::Bundle::Parser::AST::NamedArgument)
    ...
    describe "attribute references" do
      it "parses message reference with attribute" do
        ...
        message = result.first
        ref = message.value[0]
        expect(ref).to be_a(Fantail::Bundle::Parser::AST::MessageReference)
      ...
      it "parses term reference with attribute" do
        ...
        message = result.first
        ref = message.value[0]
        expect(ref).to be_a(Fantail::Bundle::Parser::AST::TermReference)
