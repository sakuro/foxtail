...
RSpec.describe Foxtail::CLDR::PluralRules do
  describe "#initialize" do
    it "loads rules for supported locale" do
      rules = Foxtail::CLDR::PluralRules.new(locale("en"))
      expect(rules).to be_instance_of(Foxtail::CLDR::PluralRules)
    end

    it "handles unsupported locale gracefully" do
      rules = Foxtail::CLDR::PluralRules.new(locale("nonexistent"))
  ...
  describe "#select" do
    context "with English locale" do
      let(:rules) { Foxtail::CLDR::PluralRules.new(locale("en")) }
    ...
    context "with Russian locale" do
      let(:rules) { Foxtail::CLDR::PluralRules.new(locale("ru")) }
    ...
    context "with Arabic locale" do
      let(:rules) { Foxtail::CLDR::PluralRules.new(locale("ar")) }
    ...
    context "with Welsh locale" do
      let(:rules) { Foxtail::CLDR::PluralRules.new(locale("cy")) }
    ...
    context "with Breton locale (complex rules)" do
      let(:rules) { Foxtail::CLDR::PluralRules.new(locale("br")) }
  ...
  describe "data loading" do
    ...
    it "returns empty hash for missing locale files" do
      rules = Foxtail::CLDR::PluralRules.new(locale("nonexistent_locale"))
