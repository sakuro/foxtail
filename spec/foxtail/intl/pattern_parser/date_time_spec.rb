...
RSpec.describe Foxtail::Intl::PatternParser::DateTime do
  subject(:parser) { Foxtail::Intl::PatternParser::DateTime.new }
  ...
  describe "#parse" do
    ...
    context "with simple field patterns" do
      it "parses year patterns" do
        ...
        expect(tokens.first).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
    ...
    context "with literal text" do
      it "parses simple literals" do
        ...
        expect(tokens).to have_attributes(size: 1)
        expect(tokens.first).to be_a(Foxtail::Intl::PatternParser::DateTime::LiteralToken)
    ...
    context "with quoted literals" do
      it "parses simple quoted text" do
        ...
        expect(tokens).to have_attributes(size: 1)
        expect(tokens.first).to be_a(Foxtail::Intl::PatternParser::DateTime::QuotedToken)
    ...
    context "with mixed patterns" do
      it "parses complex date pattern" do
        ...
        expect(tokens[0]).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
        expect(tokens[0].value).to eq("EEEE")

        expect(tokens[1]).to be_a(Foxtail::Intl::PatternParser::DateTime::LiteralToken)
        expect(tokens[1].value).to eq(", ")

        expect(tokens[2]).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
        expect(tokens[2].value).to eq("MMMM")

        expect(tokens[3]).to be_a(Foxtail::Intl::PatternParser::DateTime::LiteralToken)
        expect(tokens[3].value).to eq(" ")

        expect(tokens[4]).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
        expect(tokens[4].value).to eq("d")

        expect(tokens[5]).to be_a(Foxtail::Intl::PatternParser::DateTime::LiteralToken)
        expect(tokens[5].value).to eq(", ")

        expect(tokens[6]).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
      ...
      it "parses pattern with quoted literals" do
        ...
        expect(tokens[2]).to be_a(Foxtail::Intl::PatternParser::DateTime::QuotedToken)
      ...
      it "parses pattern with potential ambiguous tokens" do
        ...
        expect(tokens[0]).to be_a(Foxtail::Intl::PatternParser::DateTime::LiteralToken)
        expect(tokens[0].value).to eq("Info: ")

        expect(tokens[1]).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
      ...
      it "parses Japanese pattern correctly" do
        ...
        expect(tokens[3]).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
        expect(tokens[3].value).to eq("d")

        expect(tokens[4]).to be_a(Foxtail::Intl::PatternParser::DateTime::LiteralToken)
        expect(tokens[4].value).to eq("日(")

        expect(tokens[5]).to be_a(Foxtail::Intl::PatternParser::DateTime::FieldToken)
        expect(tokens[5].value).to eq("EEEE")

        expect(tokens[6]).to be_a(Foxtail::Intl::PatternParser::DateTime::LiteralToken)
  ...
  describe "Token classes" do
    describe "Token equality" do
      it "considers tokens equal if same class and value" do
        token1 = Foxtail::Intl::PatternParser::DateTime::FieldToken.new("yyyy")
        token2 = Foxtail::Intl::PatternParser::DateTime::FieldToken.new("yyyy")
        expect(token1).to eq(token2)
      end

      it "considers tokens different if different class" do
        field_token = Foxtail::Intl::PatternParser::DateTime::FieldToken.new("yyyy")
        literal_token = Foxtail::Intl::PatternParser::DateTime::LiteralToken.new("yyyy")
    ...
    describe "Token string representation" do
      it "returns value as string" do
        token = Foxtail::Intl::PatternParser::DateTime::FieldToken.new("yyyy")
